...
<script type="text/javascript">
            ...
            let url_string = "https://sntl.dev/docs/";
			let url_string2 = "https://sntl.dev/docs/create/";
            let width = "728";
            let height = "90";
            let note = "fr";
            ...
            let url_string3 = "https://sntl.dev/docs/";
			let url_string4 = "https://sntl.dev/docs/create/";
            let width3 = "728";
            let height3 = "90";
            let procedure = "fr";
...
jQuery(document).ready(function($){  
   ...
   jQuery('.doctable tr').each(function(){
        ...
        var y = jQuery.trim(x);
      if( location.href == "https://sntl.dev/docs/?note=fr&size=728x90"){
             jQuery('#bp-create-doc-button').attr('href','https://sntl.dev/docs/create/?create-note=fr&size=728x90')
             jQuery('#bp-create-doc-button').text('Nouveau note de service');
             jQuery('#bp-docs-all-docs a').text('Tous les notes de servces');
             jQuery('#bp-docs-all-docs a').attr('href','https://sntl.dev/docs/?note=fr&size=728x90');
     ...
     else if( location.href == "https://intranet-sntl.twinsmaroc.com/notes/?procedure=fr&size=728x90"){
             jQuery('#bp-create-doc-button').attr('href',' https://sntl.dev/docs/create/?create-procedure=fr&size=728x90/')
             jQuery('#bp-create-doc-button').text('Nouveau procédure');
             jQuery('#bp-docs-all-docs a').text('Tous les procédures');
             jQuery('#bp-docs-all-docs a').attr('href','https://sntl.dev/docs/?procedure=fr&size=728x90');
    ...
    jQuery('#Type > option').each(function(){
      if ( location.href == "https://sntl.dev/docs/create/?create-note=fr&size=728x90" ) { 
        jQuery('#d217').remove();
        jQuery('#d231').remove();
         jQuery('#bp-docs-all-docs a').attr('href','https://sntl.dev/docs/?note=fr&size=728x90');
     ...
     else if(location.href == "https://sntl.dev/docs/create/?create-procedure=fr&size=728x90" ) {
        jQuery('#d217').remove();
        jQuery('#d218').remove();
         jQuery('#bp-docs-all-docs a').attr('href','https://sntl.dev/docs/?procedure=fr&size=728x90');
      	jQuery('#bp-docs-all-docs a').text('Tous les procédures');
  ...
  jQuery('td#attachement-file ul li a').text('Télécharger')
